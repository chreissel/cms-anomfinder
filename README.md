...
Create a Python environment using the provided `env.yaml` file. This environment ensures that all required packages for the analysis pipeline are available, including:

- [`coffea`](https://coffeateam.github.io/coffea/)
- [`hist`](https://hist.readthedocs.io/)
- `XRootD` (for downloading CMS Open Data)
...
The framework uses **CMS Open Data (NanoAOD)** as input.

The full CMS Open Data NanoAOD dataset can be found here:
...
- `processor.py`  
  - Implements the main analysis logic
- `utils.py`  
